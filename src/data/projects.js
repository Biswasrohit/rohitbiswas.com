export const projects = [
  ...
  },
  {
    id: 2,
    title: 'Stemme.Study',
    description: 'Real-time speech therapy application with React/Express stack and bidirectional WebSocket streaming, achieving sub-500ms end-to-end latency. Architected RESTful API pipeline chaining Web Speech API, Gemini, and ElevenLabs TTS with session persistence and live transcription feedback.',
    tags: ['React', 'Node.js', 'Express', 'WebSockets', 'Gemini API', 'ElevenLabs'],
    categories: ['web', 'ai'],
  ...
  },
  {
    id: 3,
    title: 'AutoDump',
    description: 'Autonomous rover with OpenCV ArUco marker detection for vision-based docking (±2cm accuracy) and ultrasonic proximity sensing for obstacle avoidance. Python state machine orchestrating servo-controlled dump mechanism via Arduino/ROBOTIS serial integration.',
  ...
  },
  {
    ...
    description: 'Multithreaded C web server with concurrent connection handling, request parsing, MIME routing, path traversal protection, and persistent TCP connection pooling for dynamic database lookups.',
