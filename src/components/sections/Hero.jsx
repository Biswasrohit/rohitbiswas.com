  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 section-container flex flex-col items-center text-center pt-20">
        ...
        >
          <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-white dark:border-zinc-800 shadow-2xl">
            <img
          ...
          {/* Decorative ring */}
          <motion.div
            className="absolute inset-0 rounded-full border-2 border-olive-500/30"
        ...
        {/* Name */}
        <motion.h1
          className="text-4xl md:text-6xl lg:text-7xl font-bold text-zinc-900 dark:text-zinc-100 mb-4"
